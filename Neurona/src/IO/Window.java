...
//import generalIO.GridBagUtil3.Elemento;
...
public class Window {
	...
	public JFrame frame;				// frame a ser criado
	...
	class WindowListener1 implements WindowListener
	{
		...
		public void windowClosing(WindowEvent arg0) {
			...
			if(principal)
			{
				...
				if(JOptionPane.showOptionDialog(null,"Sair do sistema?","Encerrar", JOptionPane.YES_NO_CANCEL_OPTION,
	...
	public void addLine(Component comp, int length) {
		int_y++;
		Elemento.add(frameContainer, comp, 0, int_y, length, 1, 1, 1, BOTH, CENTER);
		int_y++;
	}
	
	public void setResizeable(boolean enable)
	{
